...
module.exports = function(answers) {
  ...
  const routePath = path.join(projectPath, "router");
...
`;
  ...
  // 其它模板列表规格化
  let templatesSelected = ['database', 'redis', 'auth', 'rabbitmq', 'socketio', 'nacos'];
...
`;
  ...
  console.log(chalk.green(`Cheers! Your project ${answers.name} initalized successfully! `));
