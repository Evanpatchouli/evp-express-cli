 ...
 * @returns 
 */
 const ValidRace = (validChain: validator.ValidationChain[])=>{
 ...
 * @returns 
 */
const ValidAll = (validChain: validator.ValidationChain[])=>{
  const handler: RequestHandler = async (req, res, next) => {
 ...
 * @returns 
 */
 const ValidQueue = (validChain: validator.ValidationChain[])=>{
  const handler: RequestHandler = async (req, res, next) => {
 ...
 * @returns 
 */
const ValidQueueAll = (validChain: validator.ValidationChain[])=>{
  const handler: RequestHandler = async (req, res, next) => {
    let results = [];
    for (const validate of validChain) {
        const result = await validate.run(req);
